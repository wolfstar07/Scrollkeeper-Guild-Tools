...
Scrollkeeper.NotebookMail = Scrollkeeper.NotebookMail or { Name = "ScrollkeeperNotebookMail" }
local _addon = Scrollkeeper.NotebookMail

_G.ScrollkeeperNotebookMail = Scrollkeeper.NotebookMail
